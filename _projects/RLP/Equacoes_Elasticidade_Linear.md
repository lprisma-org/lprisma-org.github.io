...
A expressão acima é geralmente separada em duas partes: o lado antes da igualdade, tratado como *left-hand side* (lhs) ou forma bilinear, e o lado após da igualdade, sendo o *right-hand side* (rhs) ou forma linear. 
